...
namespace RandomNameGen
{
    ...
    public class RandomName
    {
        ...
        class RandomList
        {
            ...
            public string[] lastspecial { get; set; }
        ...
        public RandomName(string speical, Random rand)
        {
            this.rand = rand;
            ...
            if (speical.Equals("Yes"))
            {
                Last = new List<string>(l.lastspecial);
            } else
            {
