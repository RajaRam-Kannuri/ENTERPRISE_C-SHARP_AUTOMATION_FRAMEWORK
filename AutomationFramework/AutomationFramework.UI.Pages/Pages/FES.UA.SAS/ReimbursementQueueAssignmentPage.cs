...
namespace AutomationFramework.Pages.FES.UA.SAS
{
    public class ReimbursementQueueAssignmentPage : HomePage
    {
        ...
        public Table ExistingAssignmentsTable { get; private set; }
            ...
            : base(driver)
        {
            ...
            TodaysAssignmentsTable = new Table(driver, By.CssSelector("#controls_claims_claimassignment_queueassignment_ascx441_CurrentClaimAssignments_gvAssignedClaims"));
            ExistingAssignmentsTable = new Table(driver, By.CssSelector("#controls_claims_claimassignment_queueassignment_ascx441_CurrentQueueAssignments_gvExistingQueueAssignments"));
