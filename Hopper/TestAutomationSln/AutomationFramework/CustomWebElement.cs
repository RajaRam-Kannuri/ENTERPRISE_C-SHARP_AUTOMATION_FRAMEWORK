...
namespace AutomationFramework
{
    ...
    public class CustomWebElement : IWebElement
    {
        ...
        public CustomWebElement(IWebDriver driver, By locateBy, int index = 0)
        {
        ...
        public CustomWebElement UpdateLocator(By locatedBy)
        {
            _locateBy = locatedBy;
            return this;
        }
        ...
        public void Clear()
        {
            this.LocateAndEnsureUsable().Clear();
        }
        ...
        public void Click()
        {
            ...
            elem = wait.Until(ExpectedConditions.ElementExists(this._locateBy));
            elem = wait.Until(ExpectedConditions.ElementToBeClickable(this._locateBy));
            elem.Click();
        }
