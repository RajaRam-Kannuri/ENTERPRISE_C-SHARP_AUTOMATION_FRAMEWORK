...
{
    [KeywordTesting]
    public class ProviderTable : WebElement
    {
        public ProviderTable(IWebDriver driver, By locateBy, int index = 0)
            : base(driver, locateBy, index)
        { }

        [KeywordTestingProviderTable]
        public bool ClickProviderIDForFirstRow(string text)
        {
