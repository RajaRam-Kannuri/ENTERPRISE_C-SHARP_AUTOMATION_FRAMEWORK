...
namespace GAR.SAS.Automation.Pages
{
    public class StudentDetailPage : HomePage
    {
        ...
        public DetailReportTable ApplicationTable { get; private set; }
            ...
            : base(driver)
        {
            ...
            ApplicationTable = new DetailReportTable(Driver, By.CssSelector(@"#\35 xB_gr > table > tbody > tr:nth-child(30) > td:nth-child(3) > table"));
        }
    }
}
