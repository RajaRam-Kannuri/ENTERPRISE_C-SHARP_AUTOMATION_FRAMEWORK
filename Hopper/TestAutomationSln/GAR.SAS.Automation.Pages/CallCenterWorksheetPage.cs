...
namespace GAR.SAS.Automation.Pages
{
    public class CallCenterWorksheetPage : HomePage
    {
        ...
        public GARStudentsTable StudentsTable { get; private set; }
        ...
        public OnHoldReasonsTable OnHoldReasonsTable { get; private set; }
            ...
            : base(driver)
        {
            ...
            StudentsTable = new GARStudentsTable(Driver, By.CssSelector("table[id$=\"GVStudents\"]"));
			...
			ScholarshipChildrenStatusTable = new ScholarshipChildrenStatusTable(Driver, By.CssSelector("table[id$=\"DLStudents\"]"));
            ...
            OnHoldReasonsTable = new OnHoldReasonsTable(Driver, By.CssSelector("table[id$=\"gvOHReason\"]"));
        }
	}
}
