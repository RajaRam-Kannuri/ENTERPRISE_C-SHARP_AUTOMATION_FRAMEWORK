...
namespace GAR.SAS.Automation.Pages
{
    ...
    {
        public Dropdown StudentDetailsSchoolYear { get; private set; }
        ...
        public Text ValidationMessage { get; private set; }

        public StudentDetailsPage(IWebDriver driver)
            : base(driver)
        {
            StudentDetailsSchoolYear = new Dropdown(Driver, By.CssSelector("select[id*=\"studentdetails\"][id$=\"ddlSchoolYear\"]"));
            ...
            ValidationMessage = new Text(Driver, By.CssSelector("span[style=\"color: Red\"]"));
        }
    }
}
