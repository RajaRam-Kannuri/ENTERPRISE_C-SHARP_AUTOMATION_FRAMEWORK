...
namespace GAR.SAS.Automation.Pages
{
    public class ApplicationFormPrintingPage : HomePage
    {
        ...
        public SASStudentTable StudentInfoTable { get; private set; }

        public SASStudentTable StudentTableAFP { get; private set; }
            ...
            : base(driver)
        {
            ...
            //StudentInfoTable = new SASStudentTable(Driver, By.CssSelector("table[id$=\"GVLetters\"]"));
            StudentInfoTable = new SASStudentTable(Driver, By.XPath("//*[@id='controls_applicationprocessing_applicationforms_ascx163_GVLetters']/tbody"));
            StudentTableAFP = new SASStudentTable(Driver, By.XPath("//*[@id='controls_applicationprocessing_applicationforms_ascx163_GVLetters']/tbody"));
        }
    }
}
