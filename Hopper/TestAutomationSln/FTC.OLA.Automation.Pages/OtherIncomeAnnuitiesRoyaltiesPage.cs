...
{
    public class OtherIncomeAnnuitiesRoyaltiesPage : IncomeWizardPage
    {
        ...
        public OLAWorkflowDropdown2 DocumentDropdown1 { get; private set; }
        public OLAWorkflowDropdown3 DocumentDropdown2 { get; private set; }
        ...
        public OtherIncomeAnnuitiesRoyaltiesPage(IWebDriver driver)
            : base(driver)
        {
            ...
            DocumentDropdown1 = new OLAWorkflowDropdown2(Driver, By.ClassName("select-dropdown"));
            DocumentDropdown2 = new OLAWorkflowDropdown3(Driver, By.ClassName("select-dropdown"));
