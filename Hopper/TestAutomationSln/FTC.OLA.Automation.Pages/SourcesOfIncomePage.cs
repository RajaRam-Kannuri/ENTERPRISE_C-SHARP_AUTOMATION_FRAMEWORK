...
{
    public class SourcesOfIncomePage : ApplicationWizardPage
    {
        ...
        public SourcesOfIncomePage(IWebDriver driver)
            : base(driver)
        {
            ...
            FinishButton = new Button(Driver, By.XPath("//span[text() = 'Finish']"));
        }
    }
}
