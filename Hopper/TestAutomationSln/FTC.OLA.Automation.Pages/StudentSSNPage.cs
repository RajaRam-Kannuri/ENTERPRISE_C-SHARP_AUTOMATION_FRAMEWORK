...
{
    public class StudentSSNPage : ApplicationWizardPage
    {
        ...
        public StudentSSNPage(IWebDriver driver)
            : base(driver)
        {
            ...
            SSNEnteredNumbersDoNotMatchMessage = new Text(Driver, By.XPath("//p[text() = 'The SSN/ITIN numbers entered do not match!']"));
