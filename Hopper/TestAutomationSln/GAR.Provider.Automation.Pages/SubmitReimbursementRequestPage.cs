...
{
    public class SubmitReimbursementRequestPage : ReimbursementRequestPage
    {
        public Dropdown ProviderName { get; private set; }

        public Text StudentName { get; private set; }

        public EditField PLSAId { get; private set; }
        ...
        public DropdownWithAlert LineItemCategory { get; private set; }
        ...
        public EditField LineItemAmount { get; private set; }

        public EditField LineItemTaxRateAmount { get; private set; }

        public Text LineItemTotalAmount { get; private set; }
        ...
        public ButtonWithAlert SubmitButton { get; private set; }
        ...
        public Text InvalidGardinerIDMessage { get; private set; }

        public SubmitReimbursementRequestPage(IWebDriver driver)
            : base(driver)
        {
            ProviderName = new Dropdown(Driver, By.CssSelector("select[id$=\"ddlProvider\"]"));
            StudentName = new Text(Driver, By.CssSelector("span[id$=\"lblStudentValue\"]"));
            PLSAId = new EditField(Driver, By.CssSelector("input[id$=\"txtStudentIDValue\"]"));
            ...
            LineItemCategory = new DropdownWithAlert(Driver, By.CssSelector("select[id$=\"ddlItemCategory\"]"));
            ...
            LineItemAmount = new EditField(Driver, By.CssSelector("input[id$=\"tbItemAmount\"]"));
            LineItemTaxRateAmount = new EditField(Driver, By.CssSelector("input[id$=\"tbTaxRateAmount\"]"));
            LineItemTotalAmount = new Text(Driver, By.CssSelector("span[id$=\"lblLineItemTotal\"]"));
            ...
            SubmitButton = new ButtonWithAlert(Driver, By.CssSelector("input[id$=\"btnSave\"]"));
            ...
            TandFPopupOK = new Button(Driver, By.CssSelector("body > div.ui-dialog.ui-widget.ui-widget-content.ui-corner-all.ui-draggable.ui-resizable > div.ui-dialog-buttonpane.ui-widget-content.ui-helper-clearfix > div > button"));
            ...
            InvalidGardinerIDMessage = new Text(Driver, By.CssSelector("#RPMainPanel_controls_providerlogin_submitclaim_ascx448_vsSubmitClaim > ul > li"));
        }
    }
}
